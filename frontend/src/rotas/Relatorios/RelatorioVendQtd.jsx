  ...
  const handleConsulta = async () => {
    ...
    try {
      ...
      const result = await sendByFetch({
        url: "/api/ProvaRefatora/PersisteTB/sp_consulta_prova_jp_relatorio_vendedor_qtd",
    ...
    <div className="table-component">
      <BreadCrumb
        dados={[
          ...
          { path: "", label: "Relatório Vendedor-Qtd" },
        ]}
      />
      <div>
      ...
      <Table
        titulo={"Vendedores por Quantidade de Venda"}
        header={[
...
export default RelatorioVendQtd;
